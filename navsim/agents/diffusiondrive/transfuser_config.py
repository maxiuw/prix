...
class TransfuserConfig:
    ...
    bkb_path: str = "/proj/berzelius-2023-364/users/x_liali/DiffusionDrive/pretrained/pytorch_model.bin"
    plan_anchor_path: str = "/proj/berzelius-2023-364/users/x_liali/DiffusionDrive/pretrained/kmeans_navsim_traj_20.npy"
